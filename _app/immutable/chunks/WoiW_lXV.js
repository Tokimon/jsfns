...
`,typesMarkdown:``}]},{name:`getObjectName`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">getObjectName</span>(<span class="hljs-attr" title="The object to get the name of">obj</span>: <span class="hljs-built_in">unknown</span>): <span class="hljs-built_in">string</span>
</code></pre>`,comment:``,examples:[],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : The internal type name (e.g. <code>&#39;Map&#39;</code>, <code>&#39;RegExp&#39;</code>, <code>&#39;Array&#39;</code>)</p>
`,typesMarkdown:``}]},{name:`getProperty`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">getProperty</span>&lt;T&gt;(<span class="hljs-attr" title="The object or array to read from">input</span>: <span class="hljs-title class_" data-custom-type="Dictionary">Dictionary</span> | <span class="hljs-built_in">unknown</span>[], <span class="hljs-attr" title="A dot-separated string (e.g. \`'a.b.0.c'\`) or an array of keys
...
<span class="hljs-comment">// Asserting the value&#x27;s type explicitly (not inferred - see @typeParam)</span>
getProperty&lt;<span class="hljs-built_in">number</span>&gt;({ <span class="hljs-attr">a</span>: { <span class="hljs-attr">b</span>: <span class="hljs-number">2</span> } }, <span class="hljs-string">&#x27;a.b&#x27;</span>); <span class="hljs-comment">// --&gt; value is typed \`number | null\`</span>
</code></pre>`],remarks:[`<ul>
...
</code></pre>`,comment:``,examples:[],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : Numeric representation of the hex code or <code>NaN</code> if it could not be parsed correctly to a number</p>
`,typesMarkdown:``}]},{name:`hexToRGB`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">hexToRGB</span>(<span class="hljs-attr" title="Hex color to convert to RGB">hex</span>: <span class="hljs-built_in">string</span>): <span class="hljs-title class_" data-custom-type="RGBTuple">RGBTuple</span>
...
<span class="hljs-comment">// Null on failed values</span>
<span class="hljs-title function_">hexToRGB</span>(<span class="hljs-string">&#x27;#ab&#x27;</span>); <span class="hljs-comment">// --&gt; null</span>
<span class="hljs-title function_">hexToRGB</span>(<span class="hljs-string">&#x27;&#x27;</span>); <span class="hljs-comment">// --&gt; null</span>
...
</code></pre>`],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : Array with RGB values or <code>null</code> if parsing fails</p>
...
`,typesMarkdown:``}]},{name:`isMap`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">isMap</span>(<span class="hljs-attr" title="Argument to test">x</span>: <span class="hljs-built_in">unknown</span>): <span class="hljs-title function_">boolean</span> (x is <span class="hljs-title class_">Map</span>&lt;<span class="hljs-built_in">unknown</span>, <span class="hljs-built_in">unknown</span>&gt;)
</code></pre>`,comment:``,examples:[],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : Whether the argument is a Map or not</p>
...
`,typesMarkdown:``}]},{name:`isPlainObject`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">isPlainObject</span>(<span class="hljs-attr" title="Argument to test">x</span>: <span class="hljs-built_in">unknown</span>): <span class="hljs-title function_">boolean</span> (x is <span class="hljs-title class_">Record</span>&lt;<span class="hljs-built_in">string</span>, <span class="hljs-built_in">unknown</span>&gt;)
</code></pre>`,comment:`<p>Is the given argument a plain object (created via <code>{}</code>, <code>new Object()</code>, or<br><code>Object.create(null)</code>) rather than a class instance, array, or built-in like<br><code>Date</code>/<code>Map</code>.</p>
<p>Works across realms (e.g. an object literal from an iframe), by checking the<br>prototype chain instead of identity against this realm&#39;s <code>Object.prototype</code>.</p>
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-keyword">class</span> <span class="hljs-title class_">Obj</span> {}

<span class="hljs-title function_">isPlainObject</span>({}); <span class="hljs-comment">// --&gt; true</span>
<span class="hljs-title function_">isPlainObject</span>(<span class="hljs-title class_">Object</span>.<span class="hljs-title function_">create</span>(<span class="hljs-literal">null</span>)); <span class="hljs-comment">// --&gt; true</span>
<span class="hljs-title function_">isPlainObject</span>(<span class="hljs-keyword">new</span> <span class="hljs-title class_">Obj</span>()); <span class="hljs-comment">// --&gt; false</span>
<span class="hljs-title function_">isPlainObject</span>([]); <span class="hljs-comment">// --&gt; false</span>
<span class="hljs-title function_">isPlainObject</span>(<span class="hljs-keyword">new</span> <span class="hljs-title class_">Date</span>()); <span class="hljs-comment">// --&gt; false</span>
</code></pre>`],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : Whether the argument is a plain object or not</p>
`,typesMarkdown:``}]},{name:`isSet`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">isSet</span>(<span class="hljs-attr" title="Argument to test">x</span>: <span class="hljs-built_in">unknown</span>): <span class="hljs-title function_">boolean</span> (x is <span class="hljs-title class_">Set</span>&lt;<span class="hljs-built_in">unknown</span>&gt;)
</code></pre>`,comment:``,examples:[],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : Whether the argument is a Set or not</p>
...
`,typesMarkdown:``}]},{name:`MicroEvents`,functions:[]},{name:`minDecimals`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">minDecimals</span>(<span class="hljs-attr" title="Number to pad">num</span>: <span class="hljs-built_in">number</span>, <span class="hljs-attr" title="Minimum number of decimals the result should have">decimals</span>: <span class="hljs-built_in">number</span>): <span class="hljs-built_in">string</span>
</code></pre>`,comment:`<p>Pads a number with trailing zeroes so it has at least a given number of<br>decimals, without truncating any decimals it already has beyond that.</p>
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-title function_">minDecimals</span>(<span class="hljs-number">1.2</span>, <span class="hljs-number">4</span>); <span class="hljs-comment">// --&gt; &#x27;1.2000&#x27;</span>
<span class="hljs-title function_">minDecimals</span>(<span class="hljs-number">1.23456</span>, <span class="hljs-number">2</span>); <span class="hljs-comment">// --&gt; &#x27;1.23456&#x27; (already longer, left as is)</span>
<span class="hljs-title function_">minDecimals</span>(<span class="hljs-number">1</span>, <span class="hljs-number">2</span>); <span class="hljs-comment">// --&gt; &#x27;1.00&#x27;</span>
</code></pre>`],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : The number as a string, padded to at least the given number of decimals</p>
...
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-title function_">popAtIndex</span>([<span class="hljs-number">1</span>,<span class="hljs-number">2</span>,<span class="hljs-number">3</span>], <span class="hljs-number">1</span>); <span class="hljs-comment">// --&gt; 2 (array will then be [1, 3])</span>
</code></pre>`],remarks:[`<p>This is not a pure function and will alter the given array internally</p>
`],descriptions:`<p><span class="hljs-doctag">@returns</span> : The item popped from the array, if any</p>
`,typesMarkdown:``},{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">popAtIndexPure</span>&lt;T&gt;(<span class="hljs-attr" title="The Array to remove the item from">list</span>: T[], <span class="hljs-attr" title="At what index to remove from">index</span>: <span class="hljs-built_in">number</span>): [T, T[]]
</code></pre>`,comment:`<p>Removes and returns an entry from a given array, at a designated index position.</p>
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-title function_">popAtIndexPure</span>([<span class="hljs-number">1</span>,<span class="hljs-number">2</span>,<span class="hljs-number">3</span>], <span class="hljs-number">1</span>); <span class="hljs-comment">// --&gt; [2, [1, 3]]</span>
...
`,typesMarkdown:``}]},{name:`popItem`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">popItem</span>&lt;T&gt;(<span class="hljs-attr" title="The Array to remove the item from">list</span>: T[], <span class="hljs-attr" title="The method to find the item in the array">find</span>: <span class="hljs-function">(<span class="hljs-params"><span class="hljs-attr">value</span>: T, <span class="hljs-attr">index</span>: <span class="hljs-built_in">number</span>, <span class="hljs-attr">obj</span>: T[]</span>) =&gt;</span> <span class="hljs-built_in">unknown</span>): T
</code></pre>`,comment:`<p>Find, removes and returns an entry from a given array</p>
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-title function_">popItem</span>([<span class="hljs-number">1</span>,<span class="hljs-number">2</span>,<span class="hljs-number">3</span>], <span class="hljs-function">(<span class="hljs-params">n</span>) =&gt;</span> n === <span class="hljs-number">2</span>); <span class="hljs-comment">// --&gt; 2 (array will then be [1, 3])</span>
</code></pre>`],remarks:[`<p>This is not a pure function and will alter the given array internally</p>
`],descriptions:`<p><span class="hljs-doctag">@returns</span> : The item popped from the array, if any</p>
`,typesMarkdown:``},{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">popItemPure</span>&lt;T&gt;(<span class="hljs-attr" title="The Array to remove the item from">list</span>: T[], <span class="hljs-attr" title="The method to find the item in the array">find</span>: <span class="hljs-function">(<span class="hljs-params"><span class="hljs-attr">value</span>: T, <span class="hljs-attr">index</span>: <span class="hljs-built_in">number</span>, <span class="hljs-attr">obj</span>: T[]</span>) =&gt;</span> <span class="hljs-built_in">unknown</span>): [T, T[]]
</code></pre>`,comment:`<p>Find, removes and returns an entry from a given array</p>
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-title function_">popItemPure</span>([<span class="hljs-number">1</span>,<span class="hljs-number">2</span>,<span class="hljs-number">3</span>], <span class="hljs-function">(<span class="hljs-params">n</span>) =&gt;</span> n === <span class="hljs-number">2</span>); <span class="hljs-comment">// --&gt; [2, [1, 3]]</span>
</code></pre>`],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : An array with two entries: the first entry is the value found and removed and the<br>         second is the new array with the entry removed.</p>
...
`,typesMarkdown:``}]},{name:`roundDecimals`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">roundDecimals</span>(<span class="hljs-attr" title="Number to round">num</span>: <span class="hljs-built_in">number</span>, <span class="hljs-attr" title="Maximum number of decimals to round to">decimalCount</span>: <span class="hljs-built_in">number</span>): <span class="hljs-built_in">number</span>
</code></pre>`,comment:`<p>Rounds a number to at most a given number of decimals, without padding<br>shorter results with trailing zeroes.</p>
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-title function_">roundDecimals</span>(<span class="hljs-number">3.14159</span>, <span class="hljs-number">2</span>); <span class="hljs-comment">// --&gt; 3.14</span>
<span class="hljs-title function_">roundDecimals</span>(<span class="hljs-number">3.1</span>, <span class="hljs-number">4</span>); <span class="hljs-comment">// --&gt; 3.1 (no trailing zeroes added)</span>
<span class="hljs-title function_">roundDecimals</span>(<span class="hljs-number">3.4500000003</span>, <span class="hljs-number">2</span>); <span class="hljs-comment">// --&gt; 3.45 (floating point imprecision avoided)</span>
</code></pre>`],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : The number rounded to the given number of decimals</p>
...
`,typesMarkdown:``}]},{name:`safeToFixed`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">safeToFixed</span>(<span class="hljs-attr" title="Number to format">num</span>: <span class="hljs-built_in">number</span>, <span class="hljs-attr" title="Number of decimals to fix the number to">decimals</span>: <span class="hljs-built_in">number</span>): <span class="hljs-built_in">string</span>
</code></pre>`,comment:`<p>A <code>Number.prototype.toFixed</code> wrapper that never throws — the decimal count<br>is rounded and clamped to the 0-100 range <code>toFixed</code> accepts.</p>
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-title function_">safeToFixed</span>(<span class="hljs-number">1.2345</span>, <span class="hljs-number">2</span>); <span class="hljs-comment">// --&gt; &#x27;1.23&#x27;</span>
<span class="hljs-title function_">safeToFixed</span>(<span class="hljs-number">1.2345</span>, -<span class="hljs-number">2</span>); <span class="hljs-comment">// --&gt; &#x27;1&#x27; (clamped to 0 decimals)</span>
<span class="hljs-title function_">safeToFixed</span>(<span class="hljs-number">1.2345</span>, <span class="hljs-number">150</span>); <span class="hljs-comment">// --&gt; same as (1.2345).toFixed(100) (clamped to 100 decimals)</span>
</code></pre>`],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : The number formatted to a fixed number of decimals</p>
...
`,typesMarkdown:``}]},{name:`toSafeFractionDigits`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">toSafeFractionDigits</span>(<span class="hljs-attr" title="The desired number of fraction digits">decimals</span>: <span class="hljs-built_in">number</span>): <span class="hljs-built_in">number</span>
</code></pre>`,comment:`<p>Rounds a number and clamps it to 0-100, the range <code>Number.prototype.toFixed</code><br>and <code>toExponential</code> accept as their fraction-digits argument.</p>
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-title function_">toSafeFractionDigits</span>(<span class="hljs-number">4</span>); <span class="hljs-comment">// --&gt; 4</span>
<span class="hljs-title function_">toSafeFractionDigits</span>(<span class="hljs-number">2.6</span>); <span class="hljs-comment">// --&gt; 3</span>
<span class="hljs-title function_">toSafeFractionDigits</span>(-<span class="hljs-number">2</span>); <span class="hljs-comment">// --&gt; 0</span>
<span class="hljs-title function_">toSafeFractionDigits</span>(<span class="hljs-number">150</span>); <span class="hljs-comment">// --&gt; 100</span>
</code></pre>`],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : A safe fraction-digit count between 0 and 100</p>
...
</code></pre>`,moduleName:`fuzzySearch`},{name:`SubscribeOptions`,markdown:`<pre><code class="hljs language-ts"><span class="hljs-keyword">type</span> <span class="hljs-title class_" data-custom-type="SubscribeOptions">SubscribeOptions</span> = {
  <span class="hljs-comment">// Automatically unsubscribe after the handler runs once (respects \`when\`, if given)</span>
  <span class="hljs-attr">once</span>?: <span class="hljs-built_in">boolean</span>
  <span class="hljs-comment">// Only invoke the handler when this returns true</span>
  <span class="hljs-attr">when</span>?: <span class="hljs-function">(<span class="hljs-params"><span class="hljs-attr">data</span>: <span class="hljs-title class_">TEvents</span>[K]</span>) =&gt;</span> <span class="hljs-built_in">boolean</span>
};
</code></pre>`,moduleName:`MicroEvents`},{name:`PascalCaseSettings`,markdown:`<pre><code class="hljs language-ts"><span class="hljs-keyword">type</span> <span class="hljs-title class_" data-custom-type="PascalCaseSettings">PascalCaseSettings</span> = <span class="hljs-title class_">Omit</span>&lt;<span class="hljs-title class_" data-custom-type="CamelCaseSettings">CamelCaseSettings</span>, <span class="hljs-string">&#x27;upper&#x27;</span>&gt;;
