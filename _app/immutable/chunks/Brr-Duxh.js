...
`,typesMarkdown:``}]},{name:`chunkString`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">chunkString</span>(<span class="hljs-attr" title="String to split up">str</span>: <span class="hljs-built_in">string</span>, <span class="hljs-attr" title="Size par chunk">size</span>?: <span class="hljs-built_in">number</span>): <span class="hljs-built_in">string</span>[]
</code></pre>`,comment:``,examples:[],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : Array of string chunks</p>
...
</code></pre>`,comment:`<p>Formats a number with defined thousand and decimal separator, and a decimal limit<br>(see <code>limitDecimals</code> for details on <code>decimalCount</code>)</p>
...
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-title function_">hexToRGB</span>(<span class="hljs-string">&#x27;#2fd466&#x27;</span>); <span class="hljs-comment">// --&gt; [47, 212, 102]</span>
...
</code></pre>`,comment:`<p>Limit decimals of a floating number to specified length. The length depends on <code>decimals</code><br>which can have the following settings (n = integer):</p>
<table>
<thead>
<tr>
<th>Char</th>
...
`,typesMarkdown:``}]},{name:`popIndex`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">popIndex</span>&lt;T&gt;(<span class="hljs-attr" title="The Array to remove the item from">list</span>: T[], <span class="hljs-attr" title="At what index to remove from">index</span>: <span class="hljs-built_in">number</span>): T
</code></pre>`,comment:`<p>Removes and returns an entry from a given array, at a designated index position.<br>WARNING: This is not a pure function and will alter the given array internally</p>
...
</code></pre>`],remarks:[],descriptions:``,typesMarkdown:``},{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">popIndexPure</span>(<span class="hljs-attr" title="The Array to remove the item from">list</span>: <span class="hljs-built_in">unknown</span>[], <span class="hljs-attr" title="At what index to remove from">index</span>: <span class="hljs-built_in">number</span>): [<span class="hljs-built_in">unknown</span>, <span class="hljs-built_in">unknown</span>[]]
</code></pre>`,comment:`<p>Removes and returns an entry from a given array, at a designated index position.<br>WARNING: This is not a pure function and will alter the given array internally</p>
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-title function_">popIndexPure</span>([<span class="hljs-number">1</span>,<span class="hljs-number">2</span>,<span class="hljs-number">3</span>], <span class="hljs-number">1</span>); <span class="hljs-comment">// --&gt; 2 (array will then be [1, 3])</span>
