...
<span class="hljs-title function_">attr</span>(<span class="hljs-variable language_">document</span>.<span class="hljs-property">documentElement</span>, <span class="hljs-string">&#x27;lang&#x27;</span>, <span class="hljs-string">&#x27;da-DK&#x27;</span>); <span class="hljs-comment">// --&gt; eg. &#x27;en-US&#x27; (if that was the old value)</span>

<span class="hljs-comment">// Set a boolean value</span>
<span class="hljs-title function_">attr</span>(<span class="hljs-title class_">MyInput</span>, <span class="hljs-keyword">readonly</span>, <span class="hljs-literal">true</span>); <span class="hljs-comment">// --&gt; false</span>
<span class="hljs-title function_">attr</span>(<span class="hljs-title class_">MyInput</span>, <span class="hljs-keyword">readonly</span>, <span class="hljs-literal">false</span>); <span class="hljs-comment">// --&gt; true</span>
...
<span class="hljs-title function_">css</span>(<span class="hljs-title class_">MyElm</span>, <span class="hljs-string">&#x27;color&#x27;</span>) <span class="hljs-comment">// --&gt; &#x27;rgb(0, 0, 0)&#x27;</span>
...
`,typesMarkdown:``}]},{name:`off`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">off</span>&lt;T <span class="hljs-keyword">extends</span> <span class="hljs-title class_">EventTarget</span>, E <span class="hljs-keyword">extends</span> <span class="hljs-built_in">string</span>&gt;(<span class="hljs-attr" title="DOM element to remove the event from">elm</span>: T, <span class="hljs-attr" title="Event names to remove the handler from">eventNames</span>: E | E[], <span class="hljs-attr" title="Handler to remove from the event">handler</span>: <span class="hljs-title class_" data-custom-type="EventHandler">EventHandler</span>&lt;E&gt;, <span class="hljs-attr" title="Options to pass to the 'removeEventListener'">options</span>?: <span class="hljs-title class_">AddEventListenerOptions</span>): T
</code></pre>`,comment:`<p>Remove an event handler for one or more event names from a given DOM element.</p>
...
`,typesMarkdown:``},{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">off</span>&lt;E <span class="hljs-keyword">extends</span> <span class="hljs-built_in">string</span>&gt;(<span class="hljs-attr" title="Event names to remove the handler from">eventNames</span>: E | E[], <span class="hljs-attr" title="Handler to remove from the event">handler</span>: <span class="hljs-title class_" data-custom-type="EventHandler">EventHandler</span>&lt;E&gt;, <span class="hljs-attr" title="Options to pass to the 'removeEventListener'">options</span>?: <span class="hljs-title class_">AddEventListenerOptions</span>): <span class="hljs-title class_">Document</span>
</code></pre>`,comment:`<p>Remove an event handler for one or more event names from <code>document</code></p>
...
`,typesMarkdown:``}]},{name:`on`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">on</span>&lt;T <span class="hljs-keyword">extends</span> <span class="hljs-title class_">EventTarget</span>, E <span class="hljs-keyword">extends</span> <span class="hljs-built_in">string</span>&gt;(<span class="hljs-attr" title="DOM element to bind the event to">elm</span>: T, <span class="hljs-attr" title="Event names to bind the handler to">eventNames</span>: E | E[], <span class="hljs-attr" title="Handler to bind to the event">handler</span>: <span class="hljs-title class_" data-custom-type="EventHandler">EventHandler</span>&lt;E&gt;, <span class="hljs-attr" title="Options to pass to the 'addEventListener'">options</span>?: <span class="hljs-title class_" data-custom-type="OnOptions">OnOptions</span>&lt;E&gt;): <span class="hljs-function">() =&gt;</span> T
...
`,typesMarkdown:``}]},{name:`onDomReady`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">onDomReady</span>(<span class="hljs-attr" title="Function to execute once the document has finished loading">handler</span>: <span class="hljs-function">() =&gt;</span> <span class="hljs-built_in">void</span>): <span class="hljs-built_in">void</span>
</code></pre>`,comment:`<p>Execute a given function once the document has finished loading</p>
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-title function_">domReady</span>(<span class="hljs-function">() =&gt;</span> { <span class="hljs-title function_">alert</span>(<span class="hljs-string">&#x27;DOM Ready&#x27;</span>) });
</code></pre>`],remarks:[],descriptions:``,typesMarkdown:``},{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">isDocComplete</span>(): <span class="hljs-built_in">boolean</span>
</code></pre>`,comment:`<p>Is the document ready state indicating that the document is ready to be manipulated</p>
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-title function_">isDocComplete</span>(); <span class="hljs-comment">// --&gt; true, once the DOM has finished loading</span>
</code></pre>`],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : Whether the document is ready or not</p>
...
`,typesMarkdown:``}]},{name:`trigger`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">trigger</span>&lt;T <span class="hljs-keyword">extends</span> <span class="hljs-title class_">EventTarget</span>&gt;(<span class="hljs-attr" title="DOM element to trigger the event on">elm</span>: T, <span class="hljs-attr" title="Event names to trigger">eventNames</span>: <span class="hljs-built_in">string</span> | <span class="hljs-built_in">string</span>[], <span class="hljs-attr" title="Extra data to add to the triggered event">data</span>?: <span class="hljs-built_in">unknown</span>): T
...
`,examples:[`<pre><code class="hljs language-ts"><span class="hljs-title function_">wrap</span>(<span class="hljs-variable language_">document</span>.<span class="hljs-property">documentElement</span>, <span class="hljs-string">&#x27;&lt;div /&gt;&#x27;</span>) <span class="hljs-comment">// --&gt; null - you cannot wrap the &lt;html&gt; element</span>

<span class="hljs-title function_">wrap</span>(<span class="hljs-title class_">MyElm</span>, <span class="hljs-variable language_">document</span>.<span class="hljs-title function_">createElement</span>(<span class="hljs-string">&#x27;div&#x27;</span>)) <span class="hljs-comment">// --&gt; &lt;div&gt;MyElm&lt;/div&gt;</span>
<span class="hljs-title function_">wrap</span>(<span class="hljs-title class_">MyElm</span>, <span class="hljs-string">&#x27;&lt;div class=&quot;wrap-element&quot;&gt;&lt;span&gt;&lt;b /&gt;&lt;/span&gt;&lt;/div&gt;&#x27;</span>) <span class="hljs-comment">// --&gt; the wrapper - element inserted into the &lt;b&gt; tag</span>
<span class="hljs-title function_">wrap</span>(<span class="hljs-title class_">MyElm</span>, <span class="hljs-string">&#x27;.wrap-element&#x27;</span>) <span class="hljs-comment">// --&gt; &lt;div class=&quot;wrap-element&quot;&gt;MyElm&lt;/div&gt;</span>
</code></pre>`],remarks:[],descriptions:`<p><span class="hljs-doctag">@returns</span> : The wrapper element</p>
