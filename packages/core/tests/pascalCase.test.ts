...
import { PascalCaseSettings, pascalCase } from '@js-fns/core/pascalCase';
...
describe('"pascalCase"', () => {
  ...
  describe('Passing a config object', () => {
    describe.each([emptyObj, ...createBooleanSettings<PascalCaseSettings>(settingsKeys)] as PascalCaseSettings[])('%s', (conf) => {
